      ...
      <div className="container mx-auto">
        <div className="text-center mb-8 md:mb-12">
          ...
          <p className="text-center text-muted-foreground text-sm md:text-base">
            Запишитесь на курс для риелторов
          </p>
        </div>
        <div className="grid lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
          <div className="space-y-6">
            ...
            <div className="bg-primary/5 p-6 rounded-xl border border-primary/20">
              <h3 className="font-bold mb-4 text-lg">Запись на пробное занятие</h3>
              <p className="text-muted-foreground mb-4 text-sm">
                Оставьте заявку — свяжемся и расскажем о курсе для риелторов
              </p>
              <PhoneForm source="contact_realtors" course="oratory" triggerText="Оставить заявку" triggerClassName="w-full" />
            </div>
          </div>
