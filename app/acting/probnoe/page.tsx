...
export const metadata: Metadata = {
  ...
  description:
    'Пробное занятие по актерскому мастерству в Москве: тот же зал и преподаватель, что на курсе. Фото с занятий, отзывы, запись на удобную дату. Режиссёр Казбек Меретуков.',
  alternates: { canonical: CANONICAL },
  openGraph: {
    url: CANONICAL,
    title: 'Пробное занятие по актерскому мастерству в Москве',
    description:
...
export default async function ActingTrialPage() {
  ...
  const webPageSchema = {
    ...
    '@type': 'WebPage',
    name: 'Пробное занятие по актерскому мастерству в Москве',
    description:
      'Запись на пробное занятие в школе актёрского мастерства. Связана с курсом, отдельный URL и контент от полной программы.',
    url: CANONICAL,
    isPartOf: {
      '@type': 'WebSite',
        ...
        <section className="py-10 px-4 border-t border-border/60 bg-muted/15">
          <div className="container mx-auto max-w-3xl text-center text-sm text-muted-foreground leading-relaxed">
            <p>
              ...
              — отдельная страница с программой; эта страница посвящена только пробному занятию.
            </p>
          </div>
        </section>
        <ContactSection />
